...
# test to prevent error: year 1000 is out of range
print("9999/12 has 31 days?:", days_in_month(9999, 12) == 31) 
print()

print("# Testing is_valid_date():")
print("day 30/2 is invalid?: ", is_valid_date(2018, 2, 30) is False)
print("day zero is invalid?:", is_valid_date(2018, 2, 0) is False)
print("year (MINYEAR - 1) is invalid?", is_valid_date(datetime.MINYEAR - 1, 12, 1) is False)
print("year (MAXYEAR + 1) is invalid?", is_valid_date(datetime.MAXYEAR + 1, 12, 1) is False)
print("month 13 is invalid?", is_valid_date(2018, 13, 1) is False)
print("month 0 is invalid?", is_valid_date(2018, 0, 1) is False)
...
print("1 day between 01-01 and 01-02?: ", days_between(2018, 1, 1, 2018, 1, 2) == 1)
print("30 day between 01-01 and 01-31?: ", days_between(2018, 1, 1, 2018, 1, 31) == 30)
print("32 day between 01-01 and 02-02?: ", days_between(2018, 1, 1, 2018, 2, 2) == 32)
print()
