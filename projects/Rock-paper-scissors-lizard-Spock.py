...
Solution saved in: http://py3.codeskulptor.org/#user301_tg2QlRTaIR_1.py
"""
...
def name_to_number(name):
    ...
    if name == "rock":
        ...
        print("Error: Wrong name of hand signal:", name)
        quit()
...
def number_to_name(number):
    ...
    if number == 0:
        ...
        print("Error: Wrong number of hand signal!")
...
def rpsls(player_choice):
    ...
    elif result in (1, 2): # (result == 1) or (result == 2):
        print("Player wins!")   
    else:
        print("Computer wins!")
