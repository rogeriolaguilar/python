...
# For install packages leading with several installed python versions use:
# python -m pip install [module] [module2]...
# Ex:
# python -m pip install pygal lxml
# or
# python3.6 -m pip install pygal lxml
